...
export const SPEAKERS: Speaker[] = [
  ...
  },
  {
    ...
    bio: "Dr. Tamara Petrosyan is an associate clinical professor at SUNY Optometry and New York Health and Hospitals in the Primary Care, Ocular Disease, Pediatrics, and Vision Therapy departments. Dr. Petrosyan lectures internationally and has published articles and book chapters on various topics. She helped implement free pediatric exams for over 40,000 children through the Armenian Eyecare Project and has been awarded the Young Optometrist of the Year and Optometrist of the Year from NJSOP.",
