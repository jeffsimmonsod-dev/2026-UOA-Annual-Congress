...
export const SPEAKERS: Speaker[] = [
  ...
  },
  {
    ...
    sessionIds: ["d11", "d12", "d13", "p-fri-pm1", "p-fri-pm3"],
  },
  {
    id: "s5",
  ...
  },
  {
    ...
    sessionIds: ["d19", "d20", "d21", "d22", "d23", "p5", "p6"],
  },
  {
    id: "s8",
    name: "Aubri StClair",
    ...
    bio: "Aubri StClair is a featured paraoptometric educator presenting at the 2026 UOA Annual Congress. Her four-course Saturday track covers multiple pair dispensing, work-life balance, lens tints and photochromics, and advanced lens knowledge — all approved for ABO/CPO credit.",
    photo: "https://i.pravatar.cc/300?img=56",
    sessionIds: ["p7", "p8", "p9", "p10"],
  },
  {
    id: "s9",
...
export const SESSIONS: Session[] = [
  ...
  },
  {
    ...
    track: "Meal / Social",
    speakerIds: [],
    tags: ["reception", "social", "kickoff", "sponsored"],
  },
  // ── Thursday additional events ────────────────────────────
  {
    id: "dm-thu-meeting",
    title: "UOA Business Meeting",
    description: "Utah Optometric Association Annual Business Meeting.",
    startTime: "6:00 PM",
    endTime: "7:00 PM",
    day: "Thu, June 4",
  ...
  // ── Friday meals & events ─────────────────────────────────
  {
    ...
    track: "Meal / Social",
    speakerIds: [],
    tags: ["breakfast", "sponsored", "Dompé"],
  },
  {
    id: "dm-fri-lunch",
  ...
  },
  {
    id: "dm-fri-exhibit",
    title: "Exhibit Hall",
    description: "Open to optometrists, office staff, and optometry students. Visit sponsor booths and scan QR codes to earn your passport.",
    startTime: "1:30 PM",
    endTime: "4:00 PM",
    day: "Fri, June 5",
    ...
    track: "Meal / Social",
    speakerIds: [],
    tags: ["exhibit hall", "sponsors", "networking"],
  },
  {
    id: "dm-fri-dinner",
    title: "Dinner sponsored by VSP (adults only, VSP workshop)",
    description: "Dinner event sponsored by VSP Vision. Adults only. Includes a VSP workshop. Open to registered attendees.",
    startTime: "7:00 PM",
    endTime: "9:00 PM",
    day: "Fri, June 5",
    room: "Deer Creek Ballroom",
    track: "Meal / Social",
    speakerIds: [],
    tags: ["dinner", "sponsored", "VSP", "workshop", "adults only"],
  },
  {
    id: "d1",
  ...
  // ── Saturday meals & social events ───────────────────────
  {
    ...
    track: "Meal / Social",
    speakerIds: [],
    tags: ["breakfast", "sponsored", "Waite Vision"],
  },
  {
    id: "dm-sat-lunch",
    title: "Sponsored Symposium Lunch — ODs only ($100 Visa Gift Card)",
    description: "Sponsored lunch for ODs, including a $100 Visa gift card giveaway. ODs only event.",
    startTime: "12:30 PM",
    endTime: "2:00 PM",
    day: "Sat, June 6",
    room: "Deer Creek Ballroom",
    track: "Meal / Social",
    speakerIds: [],
    tags: ["lunch", "sponsored", "ODs only", "gift card"],
  },
  {
    id: "dm-sat-exhibit",
    title: "Exhibit Hall with Raffle Drawing at 3:30 PM",
    description: "Exhibit Hall open to all attendees. Sponsor booths, passport prize drawings. Raffle drawing at 3:30 PM in the Deer Creek Ballroom.",
    startTime: "2:00 PM",
    endTime: "4:00 PM",
    day: "Sat, June 6",
    room: "Jordanelle Ballroom",
  ...
  },
  {
    ...
    description: "Family-friendly event featuring a live reptile show and prizes for the whole family. Open to all attendees and their families.",
    startTime: "4:00 PM",
    endTime: "6:00 PM",
    day: "Sat, June 6",
  ...
  {
    id: "dm-sat-networking",
    title: "OD & Student Career Networking Social (Speed Networking)",
    description: "Speed networking event for optometrists and optometry students to connect, exchange ideas, and build career relationships.",
    startTime: "5:00 PM",
    endTime: "6:30 PM",
    day: "Sat, June 6",
    ...
    track: "Meal / Social",
    speakerIds: [],
    tags: ["networking", "students", "career", "ODs"],
  },
  {
    id: "dm-sat-carnival",
    title: "Family Carnival sponsored by Utah Eye Centers",
    description: "A fun family carnival to close out Saturday evening, sponsored by Utah Eye Centers. Games, activities, and entertainment for the whole family.",
    startTime: "6:30 PM",
    endTime: "9:00 PM",
    day: "Sat, June 6",
    room: "Deer Creek Ballroom",
    track: "Meal / Social",
    speakerIds: [],
    tags: ["carnival", "family", "social", "sponsored", "Utah Eye Centers"],
  },
  // ── Sunday meals & events ─────────────────────────────────
  {
    id: "dm-sun-breakfast",
    title: "Breakfast sponsored by Bausch + Lomb",
    description: "Morning breakfast sponsored by Bausch + Lomb to start the final day of the 2026 UOA Annual Congress.",
    startTime: "7:30 AM",
    endTime: "8:00 AM",
    day: "Sun, June 7",
    room: "Strawberry Conference Room",
    track: "Meal / Social",
    speakerIds: [],
    tags: ["breakfast", "sponsored", "Bausch + Lomb"],
  },
  {
    id: "dm-sun-adjournment",
    title: "Congress Adjournment",
    description: "Official close of the 2026 UOA Annual Congress. Thank you for attending!",
    startTime: "12:00 PM",
    endTime: "12:00 PM",
    day: "Sun, June 7",
    room: "—",
...
export const PARA_SESSIONS: Session[] = [
  ...
  {
    id: "p1",
    title: "Multifocal Contacts: How They Work and How to Make Them Work (ABO/CPO)",
    description:
      "Multifocal contact lenses have highly advanced designs and are a remarkable option for presbyopes interested in minimizing their dependency on glasses. This course will describe multifocal contact lenses along with strategies to maximize their success in your office.",
    startTime: "8:00 AM",
    endTime: "9:00 AM",
    day: "Fri, June 5",
    room: "Empire Conference Room",
    track: "ABO/CPO",
    speakerIds: ["s7"],
    tags: ["multifocal", "contact lenses", "presbyopia", "ABO", "CPO"],
  },
  {
    id: "p1b",
    title: "Eliminating the Stigma From Astigmatism (ABO/CPO)",
    description:
      "Astigmatic refractive errors can be some of the most difficult but most rewarding contact lens fittings. This course offers an overview of all astigmatic contact lens options including soft toric and rigid gas permeable designs, empowering paraoptometrics with a good working knowledge of this class of specialty contact lenses.",
    startTime: "9:00 AM",
    endTime: "10:00 AM",
    day: "Fri, June 5",
    room: "Empire Conference Room",
    track: "ABO/CPO",
    speakerIds: ["s7"],
    tags: ["astigmatism", "toric", "contact lenses", "ABO", "CPO"],
  },
  {
    id: "p1c",
    title: "Eye Know What Those Drops are For! (ABO/CPO)",
    description:
      "There are many diagnostic and therapeutic eye drops used in optometric practices. This course reviews the major drops used in today's practice, teaching paraoptometrics the different classes and types of drops and their basic mechanisms of action.",
    startTime: "10:00 AM",
    endTime: "11:00 AM",
    day: "Fri, June 5",
    room: "Empire Conference Room",
    track: "ABO/CPO",
    speakerIds: ["s7"],
    tags: ["eye drops", "pharmacology", "ABO", "CPO"],
  },
  {
    id: "p1d",
    title: "The Retina You See With the OCT (ABO/CPO)",
    description:
      "The OCT has revolutionized the way we view the retina. This course will discuss the 'what and why of OCT scans' along with a greater understanding of what is being measured, empowering the allied eye care professional with deeper knowledge of this revolutionary technology.",
    startTime: "11:00 AM",
    endTime: "12:00 PM",
    day: "Fri, June 5",
    room: "Empire Conference Room",
  ...
  {
    id: "p-fri-pm1",
    title: "Peek-A-Boo: Tips and Tricks for Infant Eye Exams (CPO only)",
    description:
      "Infants present unique challenges in optometric practice. This course covers practical techniques and tips for effectively examining infants — from communication strategies to clinical insights that support the doctor during pediatric exams.",
    startTime: "4:00 PM",
    endTime: "5:00 PM",
    day: "Fri, June 5",
    room: "Empire Conference Room",
    track: "CPO",
    speakerIds: ["s4"],
    tags: ["pediatrics", "infant", "eye exam", "CPO"],
  },
  {
    id: "p-fri-pm2",
    title: "Front-Line Focus: The Paraoptometric's Role in Myopia Management (CPO only)",
    description:
      "Myopia management is a growing focus in modern optometric practice. This course empowers paras with knowledge of myopia progression, treatment options, and how paraoptometrics can support the doctor and educate patients on the front lines of myopia care.",
    startTime: "5:00 PM",
    endTime: "6:00 PM",
    day: "Fri, June 5",
    room: "Empire Conference Room",
    track: "CPO",
    speakerIds: ["s5"],
    tags: ["myopia management", "myopia", "para role", "CPO"],
  },
  {
    id: "p-fri-pm3",
    title: "Introduction to Vision Therapy Treatment (CPO only)",
    description:
      "Vision therapy is a rapidly growing area of optometric care. This course provides an introduction to vision therapy — what it is, how it works, and how paraoptometrics can support vision therapy patients and communicate effectively with families.",
    startTime: "6:00 PM",
    endTime: "7:00 PM",
    day: "Fri, June 5",
    room: "Empire Conference Room",
    track: "CPO",
    speakerIds: ["s4"],
    tags: ["vision therapy", "CPO"],
  },
  {
    id: "pm-fri-dinner",
    title: "Dinner sponsored by VSP (adults only)",
    description: "Evening dinner sponsored by VSP Vision. Adults only. Open to registered attendees.",
    startTime: "7:00 PM",
    endTime: "9:00 PM",
    day: "Fri, June 5",
    room: "Deer Creek Ballroom",
    track: "Meal / Social",
    speakerIds: [],
    tags: ["dinner", "sponsored", "VSP", "adults only"],
  },
  // ── Saturday ──────────────────────────────────────────────
  {
    id: "pm-sat-breakfast",
  ...
  {
    id: "p5",
    title: "Twelve Innovations in Eye Care That You Need to Know (CPO only)",
    description:
      "Eye care is experiencing rapid innovation which will improve patient care. This course will review new diagnostics and therapeutics and how they will play a critical role in clinical care.",
    startTime: "8:30 AM",
    endTime: "10:30 AM",
    day: "Sat, June 6",
    room: "Deer Creek Ballroom",
    track: "CPO",
    speakerIds: ["s7"],
    tags: ["innovations", "technology", "CPO"],
  },
  {
    id: "p6",
    title: "Rule These Out Before You DX Dry Eye (CPO only)",
    description:
      "Although dry eye can be debilitating for some, it can be virtually asymptomatic for others. Several conditions can mimic dry eye — this course discusses what needs to be ruled out before starting a dry eye treatment regimen.",
    startTime: "10:30 AM",
    endTime: "11:30 AM",
    day: "Sat, June 6",
    room: "Deer Creek Ballroom",
    track: "CPO",
    speakerIds: ["s7"],
    tags: ["dry eye", "differential diagnosis", "CPO"],
  },
  {
    id: "p7",
    title: "Multiple Pair: The Magic Number (ABO/CPO)",
    description:
      "This course explores the power of multiple pair dispensing and why it's one of the most impactful strategies in optical practice. Attendees will learn techniques for presenting and recommending multiple pairs to patients, understanding the value for both the patient and the practice.",
    startTime: "8:30 AM",
    endTime: "9:30 AM",
    day: "Sat, June 6",
    room: "Empire Conference Room",
    track: "ABO/CPO",
    speakerIds: ["s8"],
    tags: ["multiple pair", "dispensing", "ABO", "CPO"],
  },
  {
    id: "p8",
    title: "Healthy Work Life: You are your #1 Asset (ABO/CPO)",
    description:
      "Paraoptometrics are the backbone of a successful practice, but sustainable performance starts with personal well-being. This course explores strategies for maintaining a healthy work-life balance, managing stress, and thriving professionally.",
    startTime: "9:30 AM",
    endTime: "10:30 AM",
    day: "Sat, June 6",
    room: "Empire Conference Room",
    track: "ABO/CPO",
    speakerIds: ["s8"],
    tags: ["work-life balance", "wellness", "ABO", "CPO"],
  },
  {
    id: "p9",
    title: "True Colors: Tints, Polarization, and Photochromic Lenses (ABO/CPO)",
    description:
      "Lens tints, polarized lenses, and photochromic technology can dramatically improve patient satisfaction. This course gives paraoptometrics a working knowledge of all lens treatment options so they can confidently recommend and explain them to patients.",
    startTime: "10:30 AM",
    endTime: "11:30 AM",
    day: "Sat, June 6",
    room: "Empire Conference Room",
    track: "ABO/CPO",
    speakerIds: ["s8"],
    tags: ["lens tints", "polarization", "photochromic", "ABO", "CPO"],
  },
  {
    id: "p10",
    title: "The More You Know About Lenses: Being Well-Rounded (ABO/CPO)",
    description:
      "A well-rounded knowledge of lens options makes paras more effective consultants for patients. This course covers a broad range of lens designs, materials, and technologies to ensure paraoptometrics can speak confidently about the full optical product portfolio.",
    startTime: "11:30 AM",
    endTime: "12:30 PM",
    day: "Sat, June 6",
    room: "Empire Conference Room",
    track: "ABO/CPO",
    speakerIds: ["s8"],
    tags: ["lenses", "optics", "ABO", "CPO"],
  },
  {
    id: "pm-sat-para-social",
    title: "Para Social sponsored by Hoopes Vision (with appetizers)",
    description: "A dedicated social event for paraoptometrics, sponsored by Hoopes Vision. Enjoy appetizers and connect with fellow paras from across Utah.",
    startTime: "12:30 PM",
    endTime: "1:30 PM",
    day: "Sat, June 6",
    room: "Empire Conference Room",
    track: "Meal / Social",
    speakerIds: [],
    tags: ["para social", "networking", "sponsored", "Hoopes Vision"],
  },
  ...
  },
  {
    ...
    track: "Meal / Social",
    speakerIds: [],
    tags: ["carnival", "family", "social", "sponsored"],
  },
];
...
export const VENUE: Venue = {
  ...
  rooms: [
    {
      id: "r1",
      name: "Deer Creek Ballroom",
      capacity: 400,
      floor: "Conference Level",
      features: ["Kickoff & dinner receptions", "Breakfasts & lunches", "Doctor CE sessions", "Family Carnival"],
    },
    {
      id: "r2",
      name: "Strawberry Conference Room",
      capacity: 200,
      floor: "Conference Level",
      features: ["Thursday & Sunday doctor sessions", "Friday Klute & Brujic tracks", "Saturday Johnston & Klute tracks"],
    },
    {
      id: "r3",
      name: "Dutch Conference Room",
      capacity: 150,
      floor: "Conference Level",
      features: ["Friday Vision Therapy track", "Petrosyan & Davies sessions", "Johnston afternoon sessions"],
    },
    {
      id: "r4",
      name: "Empire Conference Room",
      capacity: 150,
      floor: "Conference Level",
      features: ["Para education sessions (Fri & Sat)", "StClair ABO/CPO track", "Para Social", "Speed Networking"],
    },
    {
      id: "r5",
      name: "Jordanelle Ballroom",
      capacity: 500,
      floor: "Main Level",
      features: ["Exhibit Hall (Fri & Sat)", "Sponsor booths", "Passport check-in"],
    },
    {
      id: "r6",
      ...
      features: ["Scales & Tails family social", "Reptile show", "Family prizes"],
    },
    {
      id: "r7",
      name: "Remington Hall Restaurant",
      capacity: 120,
      floor: "Main Level",
      features: ["Thursday MacuHealth lunch (RSVP only)", "Full-service restaurant"],
    },
  ],
};
