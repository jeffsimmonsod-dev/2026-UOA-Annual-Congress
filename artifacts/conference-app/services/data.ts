...
export const PARA_SESSIONS: Session[] = [
  ...
  {
    id: "p1",
    title: "Multifocal Contacts: How They Work and How to Make Them Work (ABO/CPC)",
    description:
    ...
    track: "ABO/CPC",
    speakerIds: ["s7"],
    tags: ["multifocal", "contact lenses", "presbyopia", "ABO", "CPC"],
  },
  {
    id: "p1b",
    title: "Eliminating the Stigma From Astigmatism (ABO/CPC)",
    description:
    ...
    track: "ABO/CPC",
    speakerIds: ["s7"],
    tags: ["astigmatism", "toric", "contact lenses", "ABO", "CPC"],
  },
  {
    id: "p1c",
    title: "Eye Know What Those Drops Are For (ABO/CPC)",
    description:
    ...
    track: "ABO/CPC",
    speakerIds: ["s7"],
    tags: ["eye drops", "pharmacology", "ABO", "CPC"],
  },
  {
    id: "p1d",
    title: "The Retina That You See with the OCT! (ABO/CPC)",
    description:
  ...
  {
    id: "p5",
    title: "Twelve Innovations in Eye Care That You Need to Know About (CPC)",
    description:
    ...
    track: "CPC",
    speakerIds: ["s7"],
    tags: ["innovations", "technology", "CPC"],
  },
  {
    id: "p6",
    title: "Rule These Out Before You Diagnose It As Dry Eye (CPC)",
    description:
    ...
    track: "CPC",
    speakerIds: ["s7"],
    tags: ["dry eye", "differential diagnosis", "CPC"],
  },
  {
    id: "pm-sat-breakfast",
    title: "Breakfast Challenge of the Clinics sponsored by Waite Vision",
